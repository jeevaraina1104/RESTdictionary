package com.dictionaryapi.main;
...
import com.dictionaryapi.main.AppMain;
import com.dictionaryapi.service.DictionaryService;
...
public class AppMain extends Application<Config> {
	...
	public void run(Config configuration, Environment environment) {
		...
		environment.jersey().register(DictionaryService.class);
	}
